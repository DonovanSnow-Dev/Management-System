Namespace Activation
    ...
    Class ActivationHandler
        ...
        Function CanHandle(args As Object) As Boolean

            Public MustOverride

        Function HandleAsync(args As Object) As Task

    End Class

    Friend MustInherit

    Class ActivationHandler(Of T As Class)

        Inherits ActivationHandler

        Protected MustOverride

        Function HandleInternalAsync(args As T) As Task
        ...
        Function CanHandleInternal(args As T) As Boolean
            Return True
        End Function
